...
public:
    ...
    Q_INVOKABLE int add(const QString &name, Gibrievida::Category *c, int minRepeats, int maxRepeats, bool useDistance, int sensorType, int sensorDelay);
...
signals:
     ...
     */
    void added(int databaseId, const QString &name, Category *c, int minRepeats, int maxRepeats, bool useDistance, int sensorType, int sensorDelay);
    /*!
